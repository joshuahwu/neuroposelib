...
write.features_h5(features, labels, path = ''.join([pstruct.out_path,'postural_feats.h5']))
...
write.features_h5(wlet_feats, wlet_labels, path = ''.join([pstruct.out_path,'kinematic_feats.h5']))
...
itf.run_analysis(params_config = '../configs/param_configs/fitsne.yaml',
                 ds = pstruct)

import pickle
pstruct = pickle.load(open('/home/exx/Desktop/GitHub/results/16_ensemble_all_feats/fitsne/datastruct.p','rb'))

features, labels =  read.features_h5(path = '/home/exx/Desktop/GitHub/results/16_ensemble_all_feats/postural_feats.h5')

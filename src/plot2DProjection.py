...
def get_data(dannceMat_filepath: str, predictions_filepath: str, skeleton_path: str, com3d_filepath = None):
  """
  ...
  """
  if dannceMat_filepath == None or predictions_filepath == None or skeleton_path == None:
    print("One or more file paths is missing. Please provide all file paths.")
  elif os.path.exists(dannceMat_filepath) and os.path.exists(predictions_filepath) and os.path.exists(skeleton_path) :
...
driver(dannceMat_filepath, predictions_filepath, videofle_path, skeleton_path, 
